...
audio.onplay = () => {
  currentIndex = 0;
  line.textContent = lyrics[0].text;
};
...
function mostrarCarta(tipo) {
  ...
  document.getElementById("cartaTexto").textContent = textos[tipo];
}
...
// SORPRESA FINAL
function sorpresa() {
  document.getElementById("sorpresaMensaje").style.display = "block";
}
